...
const Search = ({ get_categories, categories, get_products, products, get_filtered_products, searched_products, filtered_products }) => {
                ...
                <div>
                    ...
                    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="relative z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
                            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900"> Encontramos
                                ({searched_products &&
                                    searched_products !== null &&
                                    searched_products !== undefined &&
                                    searched_products.length} productos)
                            </h1>
