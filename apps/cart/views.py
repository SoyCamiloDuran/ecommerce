...
class GetItemsView(APIView):
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al recuperar los artículos del carrito.'},
        ...
        try:
            ...
            if int(product.quantity) > 0:
                ...
                if CartItem.objects.filter(cart=cart, product=product).exists():
                    ...
                    return Response(
                        {'error': 'No hay suficiente stock de este artículo.'},
...
class UpdateItemView(APIView):
    def put(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'El valor de conteo debe ser un número entero..'},
                status=status.HTTP_404_NOT_FOUND)
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al actualizar el artículo del carrito.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class RemoveItemView(APIView):
    def delete(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al eliminar el elemento.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
